...
public class Problem11 {
	...
	public Problem11()
	{
		...
		_source[0] = new int[] {8,02,22,97,38,15,00,40,00,75,04,05,07,78,52,12,50,77,91,8};
		_source[1] = new int[] {49,49,99,40,17,81,18,57,60,87,17,40,98,43,69,48,4,56,62,0};
		_source[2] = new int[] {81,49,31,73,55,79,14,29,93,71,40,67,53,88,30,03,49,13,36,65};
		_source[3] = new int[] {52,70,95,23,04,60,11,42,69,24,68,56,01,32,56,71,37,02,36,91};
		...
		_source[11] = new int[] {16,39,05,42,96,35,31,47,55,58,88,24,0,17,54,24,36,29,85,57};
		_source[12] = new int[] {86,56,0,48,35,71,89,07,05,44,44,37,44,60,21,58,51,54,17,58};
